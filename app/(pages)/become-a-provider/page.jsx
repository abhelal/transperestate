      ...
      <section className="py-10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <div className="max-w-xs">
            <img src="/images/carpenter.jpg" alt="Carpenter" className="w-64 h-40 overflow-hidden rounded-lg" />
          ...
          <div className="max-w-xs">
            <img src="/images/electrician.jpg" alt="Electrician" className="w-64 h-40 overflow-hidden rounded-lg" />
          ...
          <div className="max-w-xs">
            <img src="/images/plumber.jpg" alt="Plumber" className="w-64 h-40 overflow-hidden rounded-lg" />
          ...
          <div className="max-w-xs">
            <img src="/images/painter.jpg" alt="Painter" className="w-64 h-40 overflow-hidden rounded-lg" />
          ...
          <div className="max-w-xs">
            <img src="/images/cleaner.jpg" alt="Cleaner" className="w-64 h-40 overflow-hidden rounded-lg" />
          ...
          <div className="max-w-xs">
            <img src="/images/gardener.jpg" alt="Gardener" className="w-64 h-40 overflow-hidden rounded-lg" />
